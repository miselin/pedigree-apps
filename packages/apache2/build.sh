...
urlpackage=httpd
version=2.2.17
url="http://apache.mirror.aussiehq.net.au/$urlpackage/$urlpackage-$version.tar.gz"
...
mkdir -p $BUILD_BASE/build-$package-$version/build_apache
cd $BUILD_BASE/build-$package-$version/build_apache
